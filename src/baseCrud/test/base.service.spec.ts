...
describe('Base Service: Test suit', () => {
  ...
  describe('should update resource', () => {
    ...
    it('resource not found', async () => {
      ...
      expect(service.updateResource(resource.id, updateParams)).rejects.toThrow(NotFoundException)
  ...
  describe('should delete resource', () => {
    ...
    it('resource not found', async () => {
      ...
      expect(service.deleteResource(resource.id)).rejects.toThrow(NotFoundException)
